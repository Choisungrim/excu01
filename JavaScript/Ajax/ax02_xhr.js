...
function startMethod() {
   ...
   // c) 요청설정 : open()
   var url='../javaScript05/w06_history.html';
...
function resultF() {
   ...
   // 요청객체의 상태가 모든 데이터를 받을 수 있는 상태로 완료된 경우 (4)
      if (xhrObj.status == 200 ) { // 정상 Response Status
         document.getElementById('result_Area').innerHTML = '** 서버 Response => <br>' + xhrObj.responseText;
